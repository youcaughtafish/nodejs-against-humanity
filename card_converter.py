...
black_cards = """_? There's an app for that.
...
print('{')
print('  "whiteCards": [')
white_cards_arr = white_cards.split('\n')
i = 1
for line in white_cards_arr:
  print('    "{}"{}').format(line, (',' if i < len(white_cards_arr) else ''))
  i+=1
print('  ],')

print('  "blackCards": [')
black_cards_arr = black_cards.split('\n')
i = 1
for line in black_cards_arr:
  print('    {')
  print('      "text": "{}",'.format(line))
  print('      "pick": {},'.format(max(1, line.count('_'))))
  print('    {}{}'.format('}', ',' if i < len(black_cards_arr) else ''))
  i+=1
